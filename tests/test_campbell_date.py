...
def test_datenum_to_datetime64_matches_scalar_path():
    t = np.array([739073.0 + 0.05 / 86400 * k for k in range(5)] + [739073.5, 739088.0])
    ...
    assert str(d64[-1]) == "2023-07-21T00:00:00.000"

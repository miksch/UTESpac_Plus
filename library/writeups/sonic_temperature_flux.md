...
The validation site's campaign vs EddyPro (which consumed the logger's humidity-corrected
...
0.940 to 0.975 and lowered LE by ~0.5 %. Record: the audit doc's test-dataset
section, `tasks/archive/audit/2026-08-22_code-audit-and-python-gameplan.md`
(development tree).
